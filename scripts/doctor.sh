...
def check_replay_cache_persistence():
    ...
    tui_mod = read(Path("src/tui/mod.rs"))
    ...
    tui_mod_required = [
        "nostr_relay_keygen_blocked_message",
        "nostr_room_ready_blocks_relay_keygen_shortcut",
        "k:Relay keygen unavailable",
    ]
    ...
    room_required = [
        ...
        "Room joins include scheme (TSS or HTSS)",
        ...
        "ready_help_lines",
        "Relay keygen unavailable",
        "create keys with CLI keygen",
    ]
    ...
    if "scheme" not in run_guide or "rank" not in run_guide:
        missing.append("RUN_GUIDE TUI Nostr room scheme/rank documentation")
    if "joins honor the selected scheme and include `Rank` only for HTSS" not in run_guide:
        missing.append("RUN_GUIDE TUI Nostr room scheme-aware room join documentation")
    ...
    if "Start local keygen rehearsal; unavailable for relay transport" not in keymap:
    ...
    if "honors the configured scheme and requires `Rank` only in HTSS mode" not in keymap:
        missing.append("TUI_KEYMAP Nostr room scheme-aware room join documentation")
...
def check_transaction_review():
    ...
    required = [
        ...
        ("src/btc/hd_address.rs", read(Path("src/btc/hd_address.rs")), "child_pubkey_fingerprint"),
        ("src/btc/hd_address.rs", read(Path("src/btc/hd_address.rs")), "Child Key Fingerprint"),
        ...
        ("src/tui/state.rs", tui_state, "utxo_api_hint"),
        ...
        ("src/tui/screens/chain_select.rs", tui_chain_select, "UTXO API:"),
        ("src/tui/screens/chain_select.rs", tui_chain_select, "Confirming a different network clears pending send, reshare"),
        ("src/tui/state.rs", tui_state, "ReviewTransaction"),
        ("src/tui/state.rs", tui_state, "broadcast_status"),
        ("src/tui/components/text_area.rs", read(Path("src/tui/components/text_area.rs")), "ctrl_u_clears_multiline_paste_area"),
        ("src/tui/screens/keygen.rs", read(Path("src/tui/screens/keygen.rs")), "Paste/type JSON | Ctrl+u: Clear"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "Paste/type JSON | Ctrl+u: Clear"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "Ctrl+u: Clear"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "source or target address unavailable on"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "MISMATCH on"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "Compare manually:"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "reshare_finalize_context_names_htss_rank"),
        ("src/tui/screens/reshare.rs", read(Path("src/tui/screens/reshare.rs")), "Reject outputs for another party index, rank, or wallet"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "utxo_fetch_error"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "max_signers_message"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "no_signers_selected_message"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "deselect one before adding another"),
        ("src/tui/mod.rs", tui_keys, "No confirmed UTXOs available"),
        ("src/tui/mod.rs", tui_keys, "Insufficient confirmed balance"),
        ("src/tui/mod.rs", tui_keys, "send_missing_destination_message"),
        ("src/tui/mod.rs", tui_keys, "recipient address valid for"),
        ("src/tui/mod.rs", tui_keys, "amount in sats greater than 0"),
        ...
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "Network:"),
        ...
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "HD Address at {path}"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "hd_address_empty_state_text"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "Root source only on"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "No HD-derived addresses on"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "recipient_network_hint_line"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "Recipient network: "),
        ("src/tui/screens/nostr_sign.rs", read(Path("src/tui/screens/nostr_sign.rs")), "recipient_address_prefix_hint"),
        ("src/tui/state.rs", tui_state, "recipient_address_prefix_hint"),
        ("src/tui/state.rs", tui_state, "bcrt1..."),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "Network: "),
        ...
        ("src/tui/mod.rs", tui_keys, "y:Confirm only after every signer sees same review"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "local share material stays on this device"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "only the signed raw transaction or TXID leaves"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "attempts the selected network API"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "public transaction digest"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "session-bound and single-use"),
        ("src/tui/screens/send.rs", read(Path("src/tui/screens/send.rs")), "not a complete signature"),
        ...
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "Child x-only fingerprint"),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "Policy: "),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "UTXO API: "),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "Public derived receive address only"),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "Verify network and BIP-86 path before funding"),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "address_review_lines_show_network_path_address_and_fingerprint"),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "address_review_lines_show_regtest_api_requirement"),
        ("src/tui/screens/address_list.rs", read(Path("src/tui/screens/address_list.rs")), "Network: "),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "wallet_address_for_network"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "missing_network_address_message"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "before send, copy, or QR"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "does_not_fake_mainnet"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "does_not_reuse_testnet_address_for_regtest"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "confirming_current_network_preserves_volatile_ceremony_state"),
        ("src/tui/state.rs", tui_state, "local regtest root address with bcrt prefix"),
        ...
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "UTXO API:"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "Press {REFRESH_KEY_LABEL} to fetch"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "Send: Ready to fetch UTXOs"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "missing_network_address_message(app.network)"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "configure and join a room before multi-device signing"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "local room active for rehearsal"),
        ("src/tui/screens/home.rs", read(Path("src/tui/screens/home.rs")), "relay room active for signing"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "wallet_balance_updated_message_includes_network"),
        ...
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "Public receive address only"),
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "verify network before funding"),
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "Network: "),
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "Policy:"),
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "UTXO API:"),
        ("src/tui/screens/wallet_details.rs", read(Path("src/tui/screens/wallet_details.rs")), "missing_network_address_message(app.network)"),
        ...
        ("src/tui/mod.rs", tui_keys, "address_copy_messages_include_network_and_source_scope"),
        ("src/tui/mod.rs", tui_keys, "Copied {} root address"),
        ("src/tui/mod.rs", tui_keys, "Copied {} HD address"),
        ("src/tui/mod.rs", tui_keys, "address_balance_messages_include_network"),
        ("src/tui/mod.rs", tui_keys, "Fetching {} balance for address"),
        ("src/tui/mod.rs", tui_keys, "REFRESH_KEY_LABEL"),
        ("docs/RUN_GUIDE.md", docs, "must not fake a mainnet address"),
        ("docs/RUN_GUIDE.md", docs, "must not reuse a `tb...` testnet address as a regtest `bcrt...` address"),
        ("docs/RUN_GUIDE.md", docs, "public receive address"),
        ("docs/RUN_GUIDE.md", docs, "verify the selected network before funding"),
        ("docs/RUN_GUIDE.md", docs, "exact `UTXO API` endpoint"),
        ("docs/RUN_GUIDE.md", docs, "Wallet Details, and network selector"),
        ("docs/RUN_GUIDE.md", docs, "name the missing network address"),
        ("docs/RUN_GUIDE.md", docs, "accept `testnet`/`testnet3`, `testnet4`/`test4`"),
        ("docs/RUN_GUIDE.md", docs, "Home balance status is network-scoped"),
        ("docs/RUN_GUIDE.md", docs, "Home send readiness means the source address and UTXO API are available to fetch UTXOs"),
        ("docs/RUN_GUIDE.md", docs, "Home Nostr readiness stays in setup mode until a room is joined"),
        ("docs/RUN_GUIDE.md", docs, "Confirming a different TUI network clears pending send form data, reshare draft data"),
        ("docs/RUN_GUIDE.md", docs, "Confirming the current network leaves those drafts unchanged"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Confirming a different network clears pending send, reshare"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "confirming the current network leaves those drafts unchanged"),
        ("docs/RUN_GUIDE.md", docs, "`b/B/F5 (Refresh):Balance`"),
        ("docs/RUN_GUIDE.md", docs, "`R/r (Reload)`"),
        ("docs/RUN_GUIDE.md", docs, "The local send review shows wallet name, network"),
        ("docs/RUN_GUIDE.md", docs, "previews the expected address prefix"),
        ("docs/RUN_GUIDE.md", docs, "The TUI address check is network-scoped"),
        ("docs/RUN_GUIDE.md", docs, "match, mismatch, and missing-address results"),
        ("docs/RUN_GUIDE.md", docs, "finalize paste area shows the target party index and HTSS rank context"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Finalize shows the target party index and HTSS rank context"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "The selector shows the selected network policy"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "exact `UTXO API` endpoint"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Home shows the same `UTXO API` line"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Home Nostr readiness says to configure and join a room"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Wallet Details shows the active network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Home send readiness means the source address and UTXO API are available to fetch UTXOs"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "public receive address"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "verify the network before funding"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "name the missing network address"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "The address selection step shows the selected network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "expected address prefix"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "full BIP-86 HD source path"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "full BIP-86 HD source path and source address"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "match, mismatch, or missing-address results"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "The details panel shows the selected network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "exact `UTXO API`"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "child x-only pubkey fingerprint"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "public derived receive address"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "verify the network and BIP-86 path before funding"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Copy feedback names the selected network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "root or HD-derived address"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Balance refresh feedback names the selected network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Sighash is a public transaction digest"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Nonce JSON is session-bound and single-use"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Signature share JSON goes to the aggregator only"),
        ...
        ("docs/PROTOCOLS.md", protocols_doc, "`testnet4`/`test4`"),
        ...
        ("docs/RUN_GUIDE.md", docs, "public derived receive address"),
        ("docs/RUN_GUIDE.md", docs, "HD address-list details panel shows the selected network policy"),
        ("docs/RUN_GUIDE.md", docs, "verify the selected network and BIP-86 path before funding"),
        ("docs/RUN_GUIDE.md", docs, "TUI send source selector, send review, and Nostr proposal review show the selected source path and source address"),
        ("docs/CLI.md", read(Path("docs/CLI.md")), "short child key fingerprint"),
        ("docs/CLI.md", read(Path("docs/CLI.md")), "testnet|testnet3|testnet4|test4|signet|regtest|local|mainnet"),
        ("src/main.rs", main_rs, "parse_dkg_network"),
        ("src/main.rs", main_rs, "testnet/testnet3, testnet4/test4, signet, regtest/local"),
        ("src/main.rs", main_rs, "\"testnet4\" | \"test4\""),
        ("src/main.rs", main_rs, "\"regtest\" | \"local\""),
        ("src/btc/hd_address.rs", read(Path("src/btc/hd_address.rs")), "testnet/testnet3, testnet4/test4"),
        ...
        ("docs/RUN_GUIDE.md", docs, "root-source-only or needs an HD-derived address added first"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "every signer sees the same review"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "review help bar also says `y` confirms only after every signer sees"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "share material stays on"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Pressing `y` signs locally and attempts"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Clear focused text input or paste area"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "root-source-only or whether the user should add"),
        ...
        ("docs/RUN_GUIDE.md", docs, "Signer selection must match exactly the required threshold"),
        ("docs/RUN_GUIDE.md", docs, "Recipient validation names the active network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Transaction details validation names the active network"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Signer selection blocks review until exactly the required threshold signer set"),
        ("docs/RUN_GUIDE.md", docs, "Send review help bar repeats that `y` confirms only after every signer sees the same review"),
        ("docs/RUN_GUIDE.md", docs, "local-only boundary"),
        ("docs/RUN_GUIDE.md", docs, "only the signed raw transaction or TXID leaves"),
        ("docs/RUN_GUIDE.md", docs, "sighash is a public transaction digest"),
        ("docs/RUN_GUIDE.md", docs, "Nonce JSON is session-bound and single-use"),
        ("docs/RUN_GUIDE.md", docs, "Signature share JSON goes to the aggregator only"),
...
def check_mnemonic_backup_ux():
    ...
    required = [
        ...
        ("src/tui/screens/mnemonic.rs", screen, "Restore recreates only this party share"),
        ("src/tui/screens/mnemonic.rs", screen, "dkg-restore-mnemonic restores only this party share"),
        ("src/tui/screens/mnemonic.rs", screen, "public backup manifest"),
        ("src/tui/screens/mnemonic.rs", screen, "dkg-verify-mnemonic"),
        ("src/crypto/backup.rs", read(Path("src/crypto/backup.rs")), "shared_key_polynomial"),
        ("src/crypto/backup.rs", read(Path("src/crypto/backup.rs")), "party_ranks"),
        ...
        ("docs/TUI_KEYMAP.md", keymap, "restores only that party's local share"),
        ("docs/TUI_KEYMAP.md", keymap, "dkg-verify-mnemonic"),
        ("docs/RUN_GUIDE.md", read(Path("docs/RUN_GUIDE.md")), "does not reconstruct all shares or the full wallet key"),
...
def check_nostr_transaction_review():
    ...
    required = [
        ...
        ("src/tui/app.rs", app, "publish_nostr_tx_broadcast_from_raw_tx"),
        ...
        ("src/nostr/client.rs", client, "conversation_key_with"),
        ...
        ("src/tui/screens/nostr_sign.rs", screen, "Consent only after every signer matches review"),
        ("src/tui/screens/nostr_sign.rs", screen, "waiting_for_execution_tells_consenter_to_keep_room_open"),
        ("src/tui/screens/nostr_sign.rs", screen, "keep this room open"),
        ("src/tui/screens/nostr_sign.rs", screen, "pending_proposal_lines_show_identity_before_review"),
        ("src/tui/screens/nostr_sign.rs", screen, "pending_proposal_lines"),
        ("src/tui/screens/nostr_sign.rs", screen, "Wallet: "),
        ("src/tui/screens/nostr_sign.rs", screen, "Session: "),
        ("src/tui/screens/nostr_sign.rs", screen, "Unsigned tx: "),
        ...
        ("src/tui/screens/nostr_sign.rs", screen, "Combine handoff"),
        ("src/tui/screens/nostr_sign.rs", screen, "not an on-chain confirmation"),
        ("src/tui/screens/nostr_sign.rs", screen, "Matching tx_broadcast announcement received"),
        ("src/tui/screens/nostr_sign.rs", screen, "Announce raw tx"),
        ("src/tui/screens/nostr_sign.rs", screen, "combining_status_explains_cli_handoff_and_broadcast_wait"),
        ...
        ("docs/RUN_GUIDE.md", run_guide, "After a signer consents, the waiting state tells them to keep the room open"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "After consent, the waiting state tells the signer to keep the room open"),
        ...
        ("docs/RUN_GUIDE.md", run_guide, "copy a `frostdao dkg-broadcast` command"),
        ("docs/RUN_GUIDE.md", run_guide, "paste the signed raw transaction"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "press `c` to copy `frostdao dkg-broadcast`"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "press `a`, paste the"),
        ("docs/RUN_GUIDE.md", run_guide, "not an on-chain confirmation"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "room announcement"),
        ("docs/RUN_GUIDE.md", run_guide, "Press `r` to publish an explicit rejection"),
        ("docs/RUN_GUIDE.md", run_guide, "the consent checklist shows wallet name, network/session"),
        ("docs/RUN_GUIDE.md", run_guide, "help bar says `y` consents only after every signer matches the review"),
        ...
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "payload.unsigned_tx"),
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "session-missing-unsigned-tx"),
        ...
        ("docs/NOSTR_PROTOCOL.md", docs, "`tx_proposal` must include `unsigned_tx`"),
        ("docs/NOSTR_PROTOCOL.md", docs, "decodes as a Bitcoin transaction"),
        ...
        ("docs/TUI_KEYMAP.md", keymap, "Consent only after every signer matches the proposal review"),
        ("docs/TUI_KEYMAP.md", keymap, "consent-after-review-match wording"),
