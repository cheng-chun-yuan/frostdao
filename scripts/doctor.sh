...
def check_nostr_transaction_review():
    ...
    required = [
        ...
        ("docs/RUN_GUIDE.md", run_guide, "Regtest proposals are shown as unavailable"),
        ("docs/RUN_GUIDE.md", run_guide, "local-node CLI workflow"),
        ...
        ("src/tui/app.rs", read(Path("src/tui/app.rs")), "Nostr transaction proposals are unavailable"),
        ...
        ("src/tui/screens/nostr_sign.rs", read(Path("src/tui/screens/nostr_sign.rs")), "Switch to testnet4, testnet3, or signet"),
        ...
        ("docs/TUI_KEYMAP.md", keymap, "Regtest Nostr proposals are marked unavailable"),
