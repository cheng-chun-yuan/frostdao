...
def check_transaction_review():
    ...
    required = [
        ...
        ("src/tui/screens/chain_select.rs", tui_chain_select, "Confirming clears pending send, reshare"),
        ...
        ("docs/RUN_GUIDE.md", docs, "Confirming a new TUI network clears pending send form data, reshare draft data"),
        ("docs/TUI_KEYMAP.md", read(Path("docs/TUI_KEYMAP.md")), "Confirming a network clears pending send, reshare"),
