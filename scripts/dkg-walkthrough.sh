#!/bin/bash
# Run a quick 2-of-3 DKG walkthrough.
# Usage: ./scripts/dkg-walkthrough.sh
...
echo "FrostDAO Walkthrough - 2-of-3 Threshold DKG"
echo "============================================"
echo ""
...
echo ""
echo "All parties generated round 1 commitments."
echo "In a real ceremony, exchange these over an authenticated encrypted channel."
echo ""
...
echo "  3. Use signing commands to create threshold signatures"
