...
- The TUI address check is network-scoped. If the source or target address is unavailable on the selected network, compare the named source and target wallets manually before using the reshared wallet.
