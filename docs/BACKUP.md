...
- group public key and address fingerprint
- recovery instructions

The mnemonic is secret. The manifest is public metadata that helps verify the mnemonic belongs to the correct wallet and party.
